                ...
                <div class="row my-3">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <img class="rounded-circle" id="profile_photo"
                            ...
                            alt="{{ $data->additionalinfo->company_name ?? null }}" style="width: 200px; height: 200px;">

                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-">
                        <h3>{{ $data->additionalinfo->company_name ?? null }}</h3>
                        <p><b>@lang('additional.forms.description')</b>: {{ $data->additionalinfo->company_description ?? null }}</p>
