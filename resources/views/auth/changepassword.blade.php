@extends('layouts.app')
@section('title')
    @lang('additional.pages.login.changepassword')
@endsection
        ...
        <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <form method="post" action="{{ route('changepassword.form') }}" id="loginform">
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" 
                                name="new_password">
                            <label for="floatingInput">@lang('additional.forms.newpassword')</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" 
                                name="new_password_confirmation">
                            <label for="floatingInput">@lang('additional.forms.newpassword_confirmation')</label>
                        </div>

                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">@lang('additional.pages.login.changepassword')</button>
                    </form>
                </div>
            </div>
        </div>
