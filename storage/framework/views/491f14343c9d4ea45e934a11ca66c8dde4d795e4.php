<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('additional.pages.login.myprofile'); ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-12 col-xl-12 mx-auto">
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4"><?php echo app('translator')->get('additional.pages.login.myprofile'); ?></h6>
                        <div class="row">
                            ...
                            <div class="row my-3">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img class="rounded-circle" id="profile_photo"
                                        ...
                                        alt="<?php echo e($data->additionalinfo->company_name ?? null); ?>"
                                        style="width: 200px; height: 200px;">

                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-">
                                    <h3><?php echo e($data->additionalinfo->company_name ?? null); ?></h3>
                                    <p><b><?php echo app('translator')->get('additional.forms.description'); ?></b>: <?php echo e($data->additionalinfo->company_description ?? null); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/GlobalMartDev/AnarBey/adminstration_panel/resources/views/auth/profile.blade.php ENDPATH**/ ?>