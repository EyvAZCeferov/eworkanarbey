        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Atributlar&nbsp; <?php if(auth()->user()->hasRole('admin')): ?> <a href="<?php echo e(route('attributes.create')); ?>"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="example">
                            ...
                            <tbody>
                                <?php $__currentLoopData = attributes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>

                                        <td><?php echo e($dat->name[app()->getLocale() . '_name']); ?></td>
                                        <td><?php echo e($dat->type); ?></td>
                                        <td><?php if(isset($dat->group_id) && !empty($dat->group_id)): ?> <span class="text-success"><?php echo e($dat->group->name[app()->getLocale().'_name']); ?></span> <?php else: ?> <span class="text-danger">Yoxdur</span> <?php endif; ?></td>
                                        <td
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/GlobalMartDev/AnarBey/adminstration_panel/resources/views/attributes/index.blade.php ENDPATH**/ ?>