...
<body>
    ...
    padding: 16px;">
                                    <div class="temp-fullbleed contained" style="max-width: 600px; width: 100%;">
                                        <div class="region">
                                            <div>
                                                <?php if(isset($setting) && !empty($setting) && isset($setting->logo_dark_mode) && !empty($setting->logo_dark_mode)): ?>
...
<?php /**PATH /Applications/MAMP/htdocs/GlobalMartDev/AnarBey/adminstration_panel/resources/views/emails/sendmessage.blade.php ENDPATH**/ ?>